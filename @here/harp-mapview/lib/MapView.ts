...
export class MapView extends THREE.EventDispatcher {
    static defaultUriResolver?: UriResolver;
    ...
    constructor(options: MapViewOptions) {
        ...
        this.m_uriResolver = getOptionValue(this.m_options.uriResolver, MapView.defaultUriResolver);
    ...
    set uriResolver(uriResolver: UriResolver | undefined) {
