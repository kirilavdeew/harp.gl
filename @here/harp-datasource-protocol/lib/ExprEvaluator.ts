...
export class ExprEvaluatorContext {
    private _partialEvaluation = false;
    ...
    get partialEvaluation() {
        return this._partialEvaluation;
    }
    ...
    partiallyEvaluate(expr: Expr | undefined): Expr {
        ...
        const previousEvaluationMode = this._partialEvaluation;

        this._partialEvaluation = true;

        try {
            const value = expr.accept(this.evaluator, this);

            this._partialEvaluation = previousEvaluationMode;
